...
import { TopNav } from '@/components/ui-web/TopNav';
import VideoFeedContainer from '@/components/ui-web/VideoFeedContainer';
import { DEMO_VIDEOS } from '@/data/Video';
import MenuPopup from '@/components/ui-web/MenuPopup';
import LandingPage from '@/components/ui-web/LandingPage';
import Comments from '@/components/ui-web/Comments';
import Share from '@/components/ui-web/Share';
import Article from '@/components/ui-web/Article';
import ChatbotPopup from '@/components/ui-web/ChatbotPopup';
                    ...
                    >
                        ...
                        >
                            {categories.map((cat, index) => (
                                <div key={cat} className="flex flex-shrink-0 w-full h-full justify-center items-center">
                                    <VideoFeedContainer
