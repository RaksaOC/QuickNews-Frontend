...
const mockVideoResults = [
  {
    id: 1,
    title: 'Trump administration continues to target international students.',
  ...
  {
    id: 2,
    title: 'Global markets react to new US trade policies.',
    thumbnail: '/assets/logo2.png',
    views: '32K',
    duration: '2:31'
  },
  {
    id: 3,
    title: 'Major protests erupt in capital over education reforms.',
    thumbnail: '/assets/logo2.png',
    views: '58K',
    duration: '4:12'
  },
  ...
  {
    id: 5,
    title: 'Sports world mourns the loss of legendary coach.',
    thumbnail: '/assets/logo2.png',
    views: '65K',
    duration: '5:23'
  },
  {
    id: 6,
    title: 'Tech companies unveil latest AI-powered gadgets.',
    thumbnail: '/assets/logo2.png',
    views: '39K',
    duration: '3:07'
  }
...
export default function SearchPage() {
  ...
  return (
    <div className="relative">
      <div className={`relative min-h-screen h-screen   bg-black text-white ${isFilterOpen ? 'overflow-hidden' : 'overflow-y-scroll'}`}>
        {/* Search Header */}
              ...
              {results.map((video) => (
                <div key={video.id} className="relative">
                  ...
                  <div className="flex items-center gap-2 py-2">
                    <img src={video.thumbnail} alt={video.title} className="w-3 h-3 rounded-full" />
      ...
      {/* Render FilterPopup OUTSIDE the main div */}
