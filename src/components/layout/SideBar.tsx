...
export default function SideBar() {
    ...
    return (
        <div className={`w-60  ${searchClicked ? "w-80 min-h-[300px]" : ""} absolute top-4 left-4 bottom-4 z-50 bg-gray-500/30 backdrop-blur-sm shadow-xl border border-slate-500/80 rounded-2xl text-white transition-all duration-200 overflow-y-auto`}>
            <div className="flex flex-col h-full relative">
                {/* Sticky Header */}
                <div className="sticky top-0 z-50 bg-gray-950/40 backdrop-blur-sm px-4 pt-6 pb-4 rounded-t-2xl">
                    {/* Header */}
                            ...
                            <div className="flex-1">
                                ...
                                <div className="space-y-2 border-b border-slate-500/50 pb-4 mb-8">
                                    <button className="w-full flex items-center gap-3 px-2 py-3 rounded-xl text-white text-sm hover:bg-white/10 transition-all duration-200 group">
                                        ...
                                        <span className="font-base">Create</span>
                                    </button>
                                    <button className="w-full flex items-center gap-3 px-2 py-3 rounded-xl text-white text-sm hover:bg-white/10 transition-all duration-200 group">
                                    ...
                                    <button className="w-full flex items-center gap-3 px-2 py-3 rounded-xl text-white text-sm hover:bg-white/10 transition-all duration-200 group">
                                        ...
                                        <span className="font-base">Social</span>
                                    </button>
                                </div>

                                {/* Accounts followed */}
                                <div className="space-y-2 ">
                                    <h1 className="text-sm font-medium mb-8">Accounts followed</h1>
                                    <button className="w-full flex items-center gap-3 px-2 py-3 rounded-xl text-white text-sm hover:bg-white/10 transition-all duration-200 group">
                                        <User className="w-5 h-5 group-hover:scale-110 transition-transform" />
                                        <span className="font-base">Dylan Page</span>
                                    </button>
                                    <button className="w-full flex items-center gap-3 px-2 py-3 rounded-xl text-white text-sm hover:bg-white/10 transition-all duration-200 group">
                                        <User className="w-5 h-5 group-hover:scale-110 transition-transform" />
                                        <span className="font-base">BBC News</span>
                                    </button>
                                    <button className="w-full flex items-center gap-3 px-2 py-3 rounded-xl text-white text-sm hover:bg-white/10 transition-all duration-200 group">
                                        <User className="w-5 h-5 group-hover:scale-110 transition-transform" />
                                        <span className="font-base">Daily Mail</span>
                                    </button>
                                </div>
                            </div>
                        </>
